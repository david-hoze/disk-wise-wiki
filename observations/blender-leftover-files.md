...
- (observed on this system, 2026-02-20): Found `blender-4.3-splash.blend` (228 MB) in home directory `~/`. This is the Blender 4.3 splash screen demo file — not needed for Blender operation and safe to delete.
